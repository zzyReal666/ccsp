...
@Data
@Builder
public class DbSQLServerInstancePoolKeyDTO extends DbInstancePoolKeyDTO
{
    /** 数据库类型 */
    ...
    public DbSQLServerInstancePoolKeyDTO() {
    }

    public DbSQLServerInstancePoolKeyDTO(String databaseType, String databaseIp, String databasePort, String databaseServerName, String databaseDba) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbSQLServerInstancePoolKeyDTO)) {
            return false;
        }

        DbSQLServerInstancePoolKeyDTO that = (DbSQLServerInstancePoolKeyDTO) o;
