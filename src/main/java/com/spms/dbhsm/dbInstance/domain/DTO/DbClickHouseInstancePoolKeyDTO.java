 ...
 * @description
 * @since 2024/5/31 14:24
 */
@Data
@Builder
public class DbClickHouseInstancePoolKeyDTO  extends DbInstancePoolKeyDTO{
    /** 数据库类型 */
    ...
    public DbClickHouseInstancePoolKeyDTO() {
    }

    public DbClickHouseInstancePoolKeyDTO(String databaseType, String databaseIp, String databasePort, String databaseServerName, String databaseDba) {
