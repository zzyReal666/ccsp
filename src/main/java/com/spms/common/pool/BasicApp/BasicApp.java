package com.spms.common.pool.BasicApp;
...
public class BasicApp {
     ...
     *
     */
    String urlString = "jdbc:dm://192.168.7.149:5236";
    /**定义连接用户名
     *
     */
    ...
    public static void main(String args[]) {
        try {
            ...
            // 连接 DM 数据库
            Connection connect = basicApp.connect();
            DatabaseMetaData metaData = connect.getMetaData();
            Statement statement = connect.createStatement();
            ResultSet resultSet = statement.executeQuery("select COLUMN_1 from DMU1.TABLE_1");
            ...
            //resultSetMetaData.ge

            System.out.println(columnTypeName + "-"+columnName+"-"+nullable+"-"+columnDisplaySize);
            // 插入数据
            //System.out.println("--- 创建表 ---");
            //basicApp.createTable();
            // 插入数据
